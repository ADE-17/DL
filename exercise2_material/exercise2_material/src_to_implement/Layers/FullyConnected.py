...
class FullyConnected(BaseLayer):
    """
    Represents a FullyConnected NN layer, performs forward, backward pass, and 
    updates parameters back to the Neural Network.
    """
    ...
    def initialize(self, weights_initializer, bias_initializer):
        ...
        """
        self.weights = weights_initializer((self.input_size + 1, self.output_size))
        self.biases = bias_initializer((1, self.output_size))
